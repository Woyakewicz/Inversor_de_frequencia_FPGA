...
//altfp_compare DEVICE_FAMILY="Cyclone IV E" PIPELINE=3 WIDTH_EXP=8 WIDTH_MAN=23 agb clock dataa datab
...
//lpm_compare DEVICE_FAMILY="Cyclone IV E" LPM_PIPELINE=1 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=8 aclr aeb agb clken clock dataa datab
...
//lpm_compare DEVICE_FAMILY="Cyclone IV E" LPM_PIPELINE=1 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=7 aclr aeb agb clken clock dataa datab
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_lpm_compare 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END

//synthesis_resources = lut 113 reg 19 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  comparador_altfp_compare
	( 
	agb,
	clock,
	dataa,
	...
	wire	wire_cmpr1_aclr;
	wire	wire_cmpr1_aeb;
	wire	wire_cmpr1_agb;
	wire	wire_cmpr1_clken;
	wire	wire_cmpr1_clock;
	wire	[7:0]	wire_cmpr1_dataa;
	wire	[7:0]	wire_cmpr1_datab;
	wire	[0:0]	wire_cmpr1_aeb_reg_D;
	reg	[0:0]	wire_cmpr1_aeb_reg_Q;
	wire	[0:0]	wire_cmpr1_agb_reg_D;
	reg	[0:0]	wire_cmpr1_agb_reg_Q;
	reg	wire_cmpr2_aeb_int;
	reg	wire_cmpr2_agb_int;
	wire	wire_cmpr2_aclr;
	wire	wire_cmpr2_aeb;
	wire	wire_cmpr2_agb;
	wire	wire_cmpr2_clken;
	wire	wire_cmpr2_clock;
	wire	[7:0]	wire_cmpr2_dataa;
	wire	[7:0]	wire_cmpr2_datab;
	wire	[0:0]	wire_cmpr2_aeb_reg_D;
	reg	[0:0]	wire_cmpr2_aeb_reg_Q;
	wire	[0:0]	wire_cmpr2_agb_reg_D;
	reg	[0:0]	wire_cmpr2_agb_reg_Q;
	reg	wire_cmpr3_aeb_int;
	reg	wire_cmpr3_agb_int;
	wire	wire_cmpr3_aclr;
	wire	wire_cmpr3_aeb;
	wire	wire_cmpr3_agb;
	wire	wire_cmpr3_clken;
	wire	wire_cmpr3_clock;
	wire	[7:0]	wire_cmpr3_dataa;
	wire	[7:0]	wire_cmpr3_datab;
	wire	[0:0]	wire_cmpr3_aeb_reg_D;
	reg	[0:0]	wire_cmpr3_aeb_reg_Q;
	wire	[0:0]	wire_cmpr3_agb_reg_D;
	reg	[0:0]	wire_cmpr3_agb_reg_Q;
	reg	wire_cmpr4_aeb_int;
	reg	wire_cmpr4_agb_int;
	wire	wire_cmpr4_aclr;
	wire	wire_cmpr4_aeb;
	wire	wire_cmpr4_agb;
	wire	wire_cmpr4_clken;
	wire	wire_cmpr4_clock;
	wire	[6:0]	wire_cmpr4_dataa;
	wire	[6:0]	wire_cmpr4_datab;
	wire	[0:0]	wire_cmpr4_aeb_reg_D;
	reg	[0:0]	wire_cmpr4_aeb_reg_Q;
	wire	[0:0]	wire_cmpr4_agb_reg_D;
	reg	[0:0]	wire_cmpr4_agb_reg_Q;
	wire aclr;
	...
	assign
		wire_cmpr1_aeb_reg_D[0:0] = wire_cmpr1_aeb_int,
		wire_cmpr1_aeb = wire_cmpr1_aeb_reg_Q[0:0],
		wire_cmpr1_agb_reg_D[0:0] = wire_cmpr1_agb_int,
		wire_cmpr1_agb = wire_cmpr1_agb_reg_Q[0:0];
	//synopsys translate_off
	initial
		begin
			wire_cmpr1_aeb_reg_Q = 0;
			wire_cmpr1_agb_reg_Q = 0;
		end
	//synopsys translate_on
	always @(posedge wire_cmpr1_clock or posedge wire_cmpr1_aclr)
		if (wire_cmpr1_aclr == 1'b1) 
			begin
				wire_cmpr1_aeb_reg_Q <= 1'b0;
				wire_cmpr1_agb_reg_Q <= 1'b0;
			end
		else 
		if (wire_cmpr1_clken == 1'b1)
			begin
				wire_cmpr1_aeb_reg_Q <= wire_cmpr1_aeb_reg_D;
				wire_cmpr1_agb_reg_Q <= wire_cmpr1_agb_reg_D;
			end
	assign
		wire_cmpr1_aclr = aclr,
		wire_cmpr1_clken = clk_en,
		wire_cmpr1_clock = clock,
	...
	assign
		wire_cmpr2_aeb_reg_D[0:0] = wire_cmpr2_aeb_int,
		wire_cmpr2_aeb = wire_cmpr2_aeb_reg_Q[0:0],
		wire_cmpr2_agb_reg_D[0:0] = wire_cmpr2_agb_int,
		wire_cmpr2_agb = wire_cmpr2_agb_reg_Q[0:0];
	//synopsys translate_off
	initial
		begin
			wire_cmpr2_aeb_reg_Q = 0;
			wire_cmpr2_agb_reg_Q = 0;
		end
	//synopsys translate_on
	always @(posedge wire_cmpr2_clock or posedge wire_cmpr2_aclr)
		if (wire_cmpr2_aclr == 1'b1) 
			begin
				wire_cmpr2_aeb_reg_Q <= 1'b0;
				wire_cmpr2_agb_reg_Q <= 1'b0;
			end
		else 
		if (wire_cmpr2_clken == 1'b1)
			begin
				wire_cmpr2_aeb_reg_Q <= wire_cmpr2_aeb_reg_D;
				wire_cmpr2_agb_reg_Q <= wire_cmpr2_agb_reg_D;
			end
	assign
		wire_cmpr2_aclr = aclr,
		wire_cmpr2_clken = clk_en,
		wire_cmpr2_clock = clock,
	...
	assign
		wire_cmpr3_aeb_reg_D[0:0] = wire_cmpr3_aeb_int,
		wire_cmpr3_aeb = wire_cmpr3_aeb_reg_Q[0:0],
		wire_cmpr3_agb_reg_D[0:0] = wire_cmpr3_agb_int,
		wire_cmpr3_agb = wire_cmpr3_agb_reg_Q[0:0];
	//synopsys translate_off
	initial
		begin
			wire_cmpr3_aeb_reg_Q = 0;
			wire_cmpr3_agb_reg_Q = 0;
		end
	//synopsys translate_on
	always @(posedge wire_cmpr3_clock or posedge wire_cmpr3_aclr)
		if (wire_cmpr3_aclr == 1'b1) 
			begin
				wire_cmpr3_aeb_reg_Q <= 1'b0;
				wire_cmpr3_agb_reg_Q <= 1'b0;
			end
		else 
		if (wire_cmpr3_clken == 1'b1)
			begin
				wire_cmpr3_aeb_reg_Q <= wire_cmpr3_aeb_reg_D;
				wire_cmpr3_agb_reg_Q <= wire_cmpr3_agb_reg_D;
			end
	assign
		wire_cmpr3_aclr = aclr,
		wire_cmpr3_clken = clk_en,
		wire_cmpr3_clock = clock,
	...
	assign
		wire_cmpr4_aeb_reg_D[0:0] = wire_cmpr4_aeb_int,
		wire_cmpr4_aeb = wire_cmpr4_aeb_reg_Q[0:0],
		wire_cmpr4_agb_reg_D[0:0] = wire_cmpr4_agb_int,
		wire_cmpr4_agb = wire_cmpr4_agb_reg_Q[0:0];
	//synopsys translate_off
	initial
		begin
			wire_cmpr4_aeb_reg_Q = 0;
			wire_cmpr4_agb_reg_Q = 0;
		end
	//synopsys translate_on
	always @(posedge wire_cmpr4_clock or posedge wire_cmpr4_aclr)
		if (wire_cmpr4_aclr == 1'b1) 
			begin
				wire_cmpr4_aeb_reg_Q <= 1'b0;
				wire_cmpr4_agb_reg_Q <= 1'b0;
			end
		else 
		if (wire_cmpr4_clken == 1'b1)
			begin
				wire_cmpr4_aeb_reg_Q <= wire_cmpr4_aeb_reg_D;
				wire_cmpr4_agb_reg_Q <= wire_cmpr4_agb_reg_D;
			end
	assign
		wire_cmpr4_aclr = aclr,
		wire_cmpr4_clken = clk_en,
		wire_cmpr4_clock = clock,
...
endmodule //comparador_altfp_compare
//VALID FILE
...
module comparador (
	...
	comparador_altfp_compare	comparador_altfp_compare_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.agb (sub_wire0));
